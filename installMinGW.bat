...
curl -k -L -o MinGW32.7z https://sourceforge.net/projects/mingw-w64/files/Toolchains%20targetting%20Win32/Personal%20Builds/mingw-builds/8.1.0/threads-win32/dwarf/i686-8.1.0-release-win32-dwarf-rt_v6-rev0.7z/download
7z2301-x64.exe /S /D="C:\lbDMF\Develop\Projects\bin"
7z x MinGW32.7z -oC:\lbDMF\Develop\Tools
