...
bool MyApp::OnInit()
{
    wxFrame* frame = new MyFrame(NULL,
                                 wxID_ANY,
                                 wxT("wxAUI 0.9.1 Test Application"),
                                 wxDefaultPosition,
                                 wxSize(800, 600));
    SetTopWindow(frame);
    frame->Show();
...
wxString MyFrame::GetIntroText()
{
    const char* text =
        "<html><body>"
        "<h3>Welcome to wxAUI 0.9.1</h3>"
        "<br/><b>Overview</b><br/>"
        "<p>wxAUI is an Advanced User Interface library for the wxWidgets toolkit "
        "that allows developers to create high-quality, cross-platform user "
        "interfaces quickly and easily.</p>"
        "<p><b>Features</b></p>"
        "<p>With wxAUI version 0.9.1, developers can create application frameworks with:</p>"
        "<ul>"
        ...
        "</ul>"
        "<p><b>What's new in 0.9.1?</b></p>"
        "<p>The following features have been added since the last version of wxAUI:</p>"
        "<ul>"
        "<li>Support added for MDI frames</li>"
        "<li>Screen artifacts/paint problems fixed</li>"
        "<li>Gradient Captions Option</li>"
        "<li>Active/Inactive Panes Option</li>"
        "<li>Bug fixed with hiding/showing floated windows</li>"
        "<li>Floating Pane sizing fixes</li>"
        "<li>Drop position fixes when dragging around center pane margins</li>"
        "<li>64-bit fixes</li>"
        "<li>Switched to LF-only text file format for source code</li>"
        "</ul>"
