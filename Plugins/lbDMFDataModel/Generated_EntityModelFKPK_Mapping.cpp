...
IMPLEMENT_FUNCTOR(instanceOflbFKPK_MappingModel, lbFKPK_MappingModel)

BEGIN_IMPLEMENT_LB_UNKNOWN(lbFKPK_MappingModel)
	ADD_INTERFACE(lb_I_FKPK_Mapping)
END_IMPLEMENT_LB_UNKNOWN()

IMPLEMENT_EXTENSIBLEOBJECT(lbFKPK_MappingModel)

void		LB_STDCALL lbFKPK_MappingModel::setOperator(lb_I_Unknown* db) {

}

lbErrCodes	LB_STDCALL lbFKPK_MappingModel::ExecuteOperation(const char* operationName) {
	return ERR_NONE;
}

lbFKPK_MappingModel::lbFKPK_MappingModel() {
	...
	_CL_VERBOSE << "lbFKPK_MappingModel::lbFKPK_MappingModel() called." LOG_
}
...
lbErrCodes LB_STDCALL lbFKPK_MappingModel::setData(lb_I_Unknown*) {
	_LOG << "Error: lbFKPK_MappingModel::setData(lb_I_Unknown*) not implemented." LOG_
	return ERR_NOT_IMPLEMENTED;
}

long  LB_STDCALL lbFKPK_MappingModel::addFKPK_Mapping(const char* _pktable, const char* _pkname, const char* _fktable, const char* _fkname,  long _FKPK_MappingID) {
...
void		LB_STDCALL lbFKPK_MappingModel::deleteUnmarked() {
	lbErrCodes err = ERR_NONE;
...
void		LB_STDCALL lbFKPK_MappingModel::deleteMarked() {
	lbErrCodes err = ERR_NONE;
	FKPK_Mapping->finishIteration();
	while (hasMoreFKPK_Mapping()) {
		setNextFKPK_Mapping();
...
bool LB_STDCALL lbFKPK_MappingModel::selectFKPK_Mapping(long user_id) {
	lbErrCodes err = ERR_NONE;
...
bool LB_STDCALL lbFKPK_MappingModel::ismarked() {
	if (marked->getData() == (long) 1) return true;
	return false;
}

void LB_STDCALL lbFKPK_MappingModel::mark() {
	marked->setData((long) 1);
}

void LB_STDCALL lbFKPK_MappingModel::unmark() {
	marked->setData((long) 0);
}

int  LB_STDCALL lbFKPK_MappingModel::getFKPK_MappingCount() {
	return FKPK_Mapping->Count();
}

bool  LB_STDCALL lbFKPK_MappingModel::hasMoreFKPK_Mapping() {
	return (FKPK_Mapping->hasMoreElements() == 1);
}

void  LB_STDCALL lbFKPK_MappingModel::setNextFKPK_Mapping() {
	lbErrCodes err = ERR_NONE;
	UAP_REQUEST(getModuleInstance(), lb_I_String, paramname)
	UAP(lb_I_Parameter, param)
	UAP(lb_I_Unknown, uk)
...
void  LB_STDCALL lbFKPK_MappingModel::finishFKPK_MappingIteration() {
	FKPK_Mapping->finishIteration();
}

long LB_STDCALL lbFKPK_MappingModel::get_id() {
	return currentFKPK_MappingID->getData();
}


char* LB_STDCALL lbFKPK_MappingModel::get_pktable() {
	return currentpktable->charrep();
}

char* LB_STDCALL lbFKPK_MappingModel::get_pkname() {
	return currentpkname->charrep();
}

char* LB_STDCALL lbFKPK_MappingModel::get_fktable() {
	return currentfktable->charrep();
}

char* LB_STDCALL lbFKPK_MappingModel::get_fkname() {
...
lb_I_Unknown* LB_STDCALL lbPluginFKPK_MappingModel::peekImplementation() {
	...
	if (ukFKPK_MappingModel == NULL) {
		lbFKPK_MappingModel* FKPK_MappingModel = new lbFKPK_MappingModel();
		
	
		QI(FKPK_MappingModel, lb_I_Unknown, ukFKPK_MappingModel)
	} else {
