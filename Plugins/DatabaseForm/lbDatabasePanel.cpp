	...
	for(int i = 1; i <= columns; i++) {
		...
		*/ 
		...
		if (sampleQuery->hasFKColumn(name->charrep()) == 1) {
            addComboField(name->charrep(), sizerMain, sizerField, sizerField);
		} else {
			if (FFI->isSpecialColumn(name->charrep())) {
                addSpecialField(name->charrep(), sizerMain, sizerField, sizerField);
			} else {
                ...
                switch (coltype) {
					...
					{
                        addCheckField(name->charrep(), sizerMain, sizerField, sizerField);
						createdControl = true;
					}
					break;
					...
					{
                        addFloatField(name->charrep(), sizerMain, sizerField, sizerField);
						createdControl = true;
					}
					break;
                    case lb_I_Query::lbDBColumnChar:
					{
                        addTextField(name->charrep(), sizerMain, sizerField, sizerField);
						createdControl = true;
					}
					break;
                    case lb_I_Query::lbDBColumnDate:
					{
                        addDateField(name->charrep(), sizerMain, sizerField, sizerField);
						createdControl = true;
					}
					break;
                    ...
                    {
                        addBinaryField(name->charrep(), sizerMain, sizerField, sizerField);
                        createdControl = true;
                    }
					break;
					...
					{
                        addLongField(name->charrep(), sizerMain, sizerField, sizerField);
				        createdControl = true;
					}
					break;
                    case lb_I_Query::lbDBColumnInteger:
					{
                        addIntegerField(name->charrep(), sizerMain, sizerField, sizerField);
				        createdControl = true;
					}
					break;
