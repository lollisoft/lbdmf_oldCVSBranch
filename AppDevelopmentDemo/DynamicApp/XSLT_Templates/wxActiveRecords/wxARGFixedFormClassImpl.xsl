...
#include "<xsl:value-of select="$FormularName"/>.h"

/** ACTIVE_RECORD **/
<xsl:value-of select="$FormularName"/>::<xsl:value-of select="$FormularName"/>:wxPostgresActiveRecord()() {
}

<xsl:value-of select="$FormularName"/>::<xsl:value-of select="$FormularName"/>(const wxString&amp; name,const wxString&amp; server,const wxString&amp; user,const wxString&amp; password,const wxString&amp; table):wxPostgresActiveRecord(name,server,user,password,table){
}

<xsl:value-of select="$FormularName"/>::<xsl:value-of select="$FormularName"/>(DatabaseLayer* database,const wxString&amp; table):wxPostgresActiveRecord(database,table){
}
...
bool <xsl:value-of select="$FormularName"/>::Create(const wxString&amp; name,const wxString&amp; server,const wxString&amp; user,const wxString&amp; password,const wxString&amp; table){
	return wxPostgresActiveRecord::Create(name,server,user,password,table);
}
