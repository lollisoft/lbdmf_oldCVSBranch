 ...
 */
class DBTablesXMLWriterExtension : public lb_I_VisitorExtension {
public:
	DBTablesXMLWriterExtension();
	virtual ~DBTablesXMLWriterExtension();
...
DECLARE_FUNCTOR(instanceOfDBTablesXMLWriterExtension)
