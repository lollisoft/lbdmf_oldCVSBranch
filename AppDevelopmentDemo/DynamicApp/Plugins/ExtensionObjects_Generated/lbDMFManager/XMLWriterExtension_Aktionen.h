 ...
 */
class AktionenXMLWriterExtension : public lb_I_VisitorExtension {
public:
	AktionenXMLWriterExtension();
	virtual ~AktionenXMLWriterExtension();
...
DECLARE_FUNCTOR(instanceOfAktionenXMLWriterExtension)
