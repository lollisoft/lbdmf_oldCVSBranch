 ...
 */
class BenutzerXMLWriterExtension : public lb_I_VisitorExtension {
public:
	BenutzerXMLWriterExtension();
	virtual ~BenutzerXMLWriterExtension();
...
DECLARE_FUNCTOR(instanceOfBenutzerXMLWriterExtension)
