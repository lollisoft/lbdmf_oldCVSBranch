...
#include <DBReader_Formular_Fields_BuildFromFormularParameter.h>
								...
								if ((err == ERR_NONE) || (err == WARN_DB_NODATA)) {
									...
									switch (coltype) {
										case lb_I_Query::lbDBColumnBit:
											owningObject->addFormular_Fields(PKName->charrep(), PKTable->charrep(), "Bit", true, name->charrep(), tablename->charrep(), FormularID->getData());
											break;
										case lb_I_Query::lbDBColumnFloat:
											owningObject->addFormular_Fields(PKName->charrep(), PKTable->charrep(), "Float", true, name->charrep(), tablename->charrep(), FormularID->getData());
											break;
										case lb_I_Query::lbDBColumnChar:
											owningObject->addFormular_Fields(PKName->charrep(), PKTable->charrep(), "String", true, name->charrep(), tablename->charrep(), FormularID->getData());
											break;
										case lb_I_Query::lbDBColumnBinary:
											owningObject->addFormular_Fields(PKName->charrep(), PKTable->charrep(), "Binary", true, name->charrep(), tablename->charrep(), FormularID->getData());
											break;
										...
										case lb_I_Query::lbDBColumnInteger:
											...
											owningObject->addFormular_Fields(PKName->charrep(), PKTable->charrep(), "Integer", true, name->charrep(), tablename->charrep(), FormularID->getData());
											break;
									...
									switch (coltype) {
										case lb_I_Query::lbDBColumnBit:
											owningObject->addFormular_Fields("", "", "Bit", false, name->charrep(), tablename->charrep(), FormularID->getData());
											break;
										case lb_I_Query::lbDBColumnFloat:
											owningObject->addFormular_Fields("", "", "Float", false, name->charrep(), tablename->charrep(), FormularID->getData());
											break;
										case lb_I_Query::lbDBColumnChar:
											owningObject->addFormular_Fields("", "", "String", false, name->charrep(), tablename->charrep(), FormularID->getData());
											break;
										case lb_I_Query::lbDBColumnBinary:
											owningObject->addFormular_Fields("", "", "Binary", false, name->charrep(), tablename->charrep(), FormularID->getData());
											break;

										case lb_I_Query::lbDBColumnBigInteger:
										case lb_I_Query::lbDBColumnInteger:
											owningObject->addFormular_Fields("", "", "Integer", false, name->charrep(), tablename->charrep(), FormularID->getData());
											break;
										case lb_I_Query::lbDBColumnUnknown:
											_CL_LOG << "lbDatabasePanel::init(...) Creating control failed due to unknown column type" LOG_
											break;
