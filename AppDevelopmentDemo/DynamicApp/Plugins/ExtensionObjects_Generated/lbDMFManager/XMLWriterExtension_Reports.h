 ...
 */
class ReportsXMLWriterExtension : public lb_I_VisitorExtension {
public:
	ReportsXMLWriterExtension();
	virtual ~ReportsXMLWriterExtension();
...
DECLARE_FUNCTOR(instanceOfReportsXMLWriterExtension)
