 ...
 */
class ReportsDBReaderExtension : public lb_I_VisitorExtension {
public:
	ReportsDBReaderExtension();
	virtual ~ReportsDBReaderExtension();
...
DECLARE_FUNCTOR(instanceOfReportsDBReaderExtension)
