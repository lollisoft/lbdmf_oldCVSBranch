 ...
 */
class AktionenInternalFormatWriterExtension : public lb_I_VisitorExtension {
public:
	AktionenInternalFormatWriterExtension();
	virtual ~AktionenInternalFormatWriterExtension();
...
DECLARE_FUNCTOR(instanceOfAktionenInternalFormatWriterExtension)
