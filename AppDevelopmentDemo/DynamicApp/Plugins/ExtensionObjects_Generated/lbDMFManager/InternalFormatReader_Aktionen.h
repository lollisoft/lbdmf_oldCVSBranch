 ...
 */
class AktionenInternalFormatReaderExtension : public lb_I_VisitorExtension {
public:
	AktionenInternalFormatReaderExtension();
	virtual ~AktionenInternalFormatReaderExtension();
...
DECLARE_FUNCTOR(instanceOfAktionenInternalFormatReaderExtension)
