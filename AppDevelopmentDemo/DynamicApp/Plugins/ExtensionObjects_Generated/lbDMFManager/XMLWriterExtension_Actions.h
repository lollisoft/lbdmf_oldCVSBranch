 ...
 */
class ActionsXMLWriterExtension : public lb_I_VisitorExtension {
public:
	ActionsXMLWriterExtension();
	virtual ~ActionsXMLWriterExtension();
...
DECLARE_FUNCTOR(instanceOfActionsXMLWriterExtension)
