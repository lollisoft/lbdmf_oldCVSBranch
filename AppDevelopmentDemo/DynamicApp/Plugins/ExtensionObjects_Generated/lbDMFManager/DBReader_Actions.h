 ...
 */
class ActionsDBReaderExtension : public lb_I_VisitorExtension {
public:
	ActionsDBReaderExtension();
	virtual ~ActionsDBReaderExtension();
...
DECLARE_FUNCTOR(instanceOfActionsDBReaderExtension)
