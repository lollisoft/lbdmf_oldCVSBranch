...
// Generated plugin definitions
	ADD_PLUGIN(lbPluginDBPrimaryKeysInternalFormatReaderExtension, InputStreamVisitor_DBPrimaryKeysModel)
	ADD_PLUGIN(lbPluginDBPrimaryKeysDBReaderExtension, DatabaseInputStreamVisitor_DBPrimaryKeysModel)
	ADD_PLUGIN(lbPluginDBPrimaryKeysInternalFormatWriterExtension, OutputStreamVisitor_DBPrimaryKeysModel)
	ADD_PLUGIN(lbPluginDBPrimaryKeysXMLWriterExtension, XMLOutputStreamVisitor_DBPrimaryKeysModel)

	ADD_PLUGIN(lbPluginDBForeignKeysInternalFormatReaderExtension, InputStreamVisitor_DBForeignKeysModel)
	ADD_PLUGIN(lbPluginDBForeignKeysDBReaderExtension, DatabaseInputStreamVisitor_DBForeignKeysModel)
	ADD_PLUGIN(lbPluginDBForeignKeysInternalFormatWriterExtension, OutputStreamVisitor_DBForeignKeysModel)
	ADD_PLUGIN(lbPluginDBForeignKeysXMLWriterExtension, XMLOutputStreamVisitor_DBForeignKeysModel)

	ADD_PLUGIN(lbPluginDBColumnsInternalFormatReaderExtension, InputStreamVisitor_DBColumnsModel)
	ADD_PLUGIN(lbPluginDBColumnsDBReaderExtension, DatabaseInputStreamVisitor_DBColumnsModel)
	ADD_PLUGIN(lbPluginDBColumnsInternalFormatWriterExtension, OutputStreamVisitor_DBColumnsModel)
	ADD_PLUGIN(lbPluginDBColumnsXMLWriterExtension, XMLOutputStreamVisitor_DBColumnsModel)

	ADD_PLUGIN(lbPluginDBTablesInternalFormatReaderExtension, InputStreamVisitor_DBTablesModel)
	ADD_PLUGIN(lbPluginDBTablesDBReaderExtension, DatabaseInputStreamVisitor_DBTablesModel)
	ADD_PLUGIN(lbPluginDBTablesInternalFormatWriterExtension, OutputStreamVisitor_DBTablesModel)
	ADD_PLUGIN(lbPluginDBTablesXMLWriterExtension, XMLOutputStreamVisitor_DBTablesModel)
