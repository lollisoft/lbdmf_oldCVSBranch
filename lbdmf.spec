...
%suse_update_desktop_file -c wxWrapper-help 'Rapid Database GUI Designer help' 'Help for database designer based on wxWrapper' '%{prefix}/share/lbdmf/Doc/DynamicApp.pdf %{prefix}/share/lbdmf/toolbaricons/ktip.png Development
